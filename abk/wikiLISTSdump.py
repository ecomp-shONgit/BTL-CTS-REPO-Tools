...
#INURL 
#urls = ["https://de.wikipedia.org/wiki/Liste_der_Abk%C3%BCrzungen_antiker_Autoren_und_Werktitel/A", "https://de.wikipedia.org/wiki/Liste_der_Abk%C3%BCrzungen_antiker_Autoren_und_Werktitel/B"]
...
for u in range( len( urls ) ):
    ...
    with urllib.request.urlopen( urls[u] ) as response:
        ...
        for l in range(len(tablelines)):
            ...
            count += 1
        #print(thetable)
fifa = io.open( "wikiPlistAAuto.csv", "w", encoding="utf8" )
